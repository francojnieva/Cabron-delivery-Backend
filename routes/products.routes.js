...
const {createProduct, getAllProducts, getOneProduct, deleteProduct, editProduct, addProductToCart, getDiscountProducts} = require('../controllers/product.controllers')
